...
set label "{/:Bold {/:Italic FSSH} }" front offset 3, 9
plot "model_1/de_0.001/none_ida/V01_0.003/_tmp_01_300.0_0.0.txt"  using ($1/41.34137):7 w l lt 2 lw 8 t "{/Symbol D}_{E} = 0.001 Ha",\
     "model_1/de_0.003/none_ida/V01_0.003/_tmp_01_300.0_0.0.txt"  using ($1/41.34137):7 w l lt 3 lw 8 t "{/Symbol D}_{E} = 0.003 Ha",\
     "model_1/de_0.01/none_ida/V01_0.003/_tmp_01_300.0_0.0.txt"   using ($1/41.34137):7 w l lt 4 lw 8 t "{/Symbol D}_{E} = 0.01 Ha",\
     "model_1/de_0.001/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt" using ($1/41.34137):($5) w l lt 12 lw 8 t "",\
     "model_1/de_0.003/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt" using ($1/41.34137):($5) w l lt 13 lw 8 t "",\
...
plot "model_1/de_0.001/none_ida/V01_0.003/_tmp_11_300.0_0.0.txt" using ($1/41.34137):7 w l lt 2 lw 8 t "",\
     "model_1/de_0.003/none_ida/V01_0.003/_tmp_11_300.0_0.0.txt" using ($1/41.34137):7 w l lt 3 lw 8 t "",\
     "model_1/de_0.01/none_ida/V01_0.003/_tmp_11_300.0_0.0.txt"  using ($1/41.34137):7 w l lt 4 lw 8 t "",\
     "model_1/de_0.001/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt" using ($1/41.34137):($5) w l lt 12 lw 8 t "",\
     "model_1/de_0.003/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt" using ($1/41.34137):($5) w l lt 13 lw 8 t "",\
...
plot "model_1/de_0.001/msdm_dish/10fs/V01_0.003/_tmp_21_300.0_10.0.txt" using ($1/41.34137):7 w l lt 2 lw 8 t "",\
     "model_1/de_0.003/msdm_dish/10fs/V01_0.003/_tmp_21_300.0_10.0.txt" using ($1/41.34137):7 w l lt 3 lw 8 t "",\
     "model_1/de_0.01/msdm_dish/10fs/V01_0.003/_tmp_21_300.0_10.0.txt"  using ($1/41.34137):7 w l lt 4 lw 8 t "",\
     "model_1/de_0.001/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt"       using ($1/41.34137):($5) w l lt 12 lw 8 t "",\
     "model_1/de_0.003/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt"       using ($1/41.34137):($5) w l lt 13 lw 8 t "",\
...
plot "model_1/de_0.001/msdm_dish/10fs/V01_0.003/_tmp_31_300.0_10.0.txt" using ($1/41.34137):7 w l lt 2 lw 8 t "",\
     "model_1/de_0.003/msdm_dish/10fs/V01_0.003/_tmp_31_300.0_10.0.txt" using ($1/41.34137):7 w l lt 3 lw 8 t "",\
     "model_1/de_0.01/msdm_dish/10fs/V01_0.003/_tmp_31_300.0_10.0.txt"  using ($1/41.34137):7 w l lt 4 lw 8 t "",\
     "model_1/de_0.001/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt"       using ($1/41.34137):($5) w l lt 12 lw 8 t "",\
     "model_1/de_0.003/none_ida/V01_0.003/_out_0_1_300.0_0.0.txt"       using ($1/41.34137):($5) w l lt 13 lw 8 t "",\
