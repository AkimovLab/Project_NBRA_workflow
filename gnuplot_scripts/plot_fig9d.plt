...
set xtics 300
set ytics 1
set label "{/:Bold {/:Italic mSDM 10 fs}}" at 250, 0.825
...
plot "model_3/msdm_dish/10_50/_tmp21_10.0.txt" using ($1/41.34137):($10) w l lt 2 lw 8 t "",\
     "model_3/msdm_dish/10_50/_tmp21_10.0.txt" using ($1/41.34137):($7)  w l lt 3 lw 8 t "",\
     "model_3/msdm_dish/10_50/_tmp21_10.0.txt" using ($1/41.34137):($4)  w l lt 4 lw 8 t "",\
     "model_3/msdm_dish/10_50/_out_2_1_300.0_10.0.txt" using ($1/41.34137):8  w l lt 12 lw 8 t "",\
     "model_3/msdm_dish/10_50/_out_2_1_300.0_10.0.txt" using ($1/41.34137):7  w l lt 13 lw 8 t "",\
     "model_3/msdm_dish/10_50/_out_2_1_300.0_10.0.txt" using ($1/41.34137):6  w l lt 14 lw 8 t "",\
